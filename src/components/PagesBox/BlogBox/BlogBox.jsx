...
const BlogBox = () => {
	...
	// ================
	let { BlogLoadingData, postCategory, pagesTargetData } = useSelector((state) => state.BlogDataReducer);
	// ================
					...
					{BlogLoadingData ? (
						...
						<div className='content-blog'>
							<div
								...
								onClick={() => {
									navigate(`/detail/${pagesTargetData[0].id}`);
									goUpWindow();
								}}
							>
								...
								<div className='box-left'>
									...
									{/**
                                    <OwnerBox NameOwner={pagesTargetData[0].user.name} DateOwner={pagesTargetData[0].user.created_at} ImgOwner={pagesTargetData[0].user.image} />
                                 */}
								</div>
							</div>
